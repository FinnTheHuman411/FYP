...
public class Activity_Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (usdb.chkusername("admin") == true){
            ...
            // Insert Sample foods
            fdb.insert(3001, "Biscuit St Esteve", "Cake", "Biscuit St Estève, ganache & gel abricot, chocolat blanc & sorbet abricot.", 30.0, "https://i.imgur.com/04pV3fn.jpg", "https://github.com/FinnTheHuman411/hkmukevin03fypassets/blob/main/biscuit_st_esteve.glb?raw=true", 0.75, 1.25);
            ...
            fdb.insert(2001, "Goat cheese tartine", "Bread", "Toast with goat-milk made cheese with salad.", 72.0, "https://i.imgur.com/tHs4815.jpg", "https://github.com/FinnTheHuman411/hkmukevin03fypassets/blob/main/goat_cheese_tartine.glb?raw=true", 0.75, 1.25);
            ...
            fdb.insert(3002, "Miage Pie", "Pie/Tart", "Raspberry Pie with cream.", 29.0, "https://i.imgur.com/3XleQRc.jpg", "https://github.com/FinnTheHuman411/hkmukevin03fypassets/blob/main/miage_pie.glb?raw=true", 0.75, 1.25);
            ...
            fdb.insert(2006, "Barbecued Rib", "Meat", "Rib (beef) with barbecue sauce and pea sprout.", 99.0, "https://i.imgur.com/kwtbAwm.jpg", "https://github.com/FinnTheHuman411/hkmukevin03fypassets/blob/main/bbq_ribs.glb?raw=true", 0.75, 1.25);
            fdb.insert(1001, "Salad", "Appetizer", "Garden Salad.", 32.0, "https://i.imgur.com/30DpBqe.jpg", "https://github.com/FinnTheHuman411/hkmukevin03fypassets/blob/main/salad_plate.glb?raw=true", 0.75, 1.25);
