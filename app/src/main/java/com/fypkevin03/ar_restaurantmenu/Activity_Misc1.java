...
public class Activity_Misc1 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_misc1);
    ...
    public void btn_add(View v){
        add_to_shopping_cart(2001, 1, "Nikujaga (Beef and Potatoes)", 45, R.drawable.ms1);
    }
